...
void mfp_gpio2_power_up(void)
{
	__raw_writel(FIRST_SECURITY_VALUE,APBC_PXA168_ASFAR);
	__raw_writel(SECOND_SECURITY_VALUE,APBC_PXA168_ASSAR);
	__raw_writel(AIB_POWER_TURNON,AIB_GPIO2_IO);
}

void mfp_gpio3_power_up(void)
{
	__raw_writel(FIRST_SECURITY_VALUE,APBC_PXA168_ASFAR);
	__raw_writel(SECOND_SECURITY_VALUE,APBC_PXA168_ASSAR);
...
void mfp_gpio2_power_down(void)
{
	__raw_writel(FIRST_SECURITY_VALUE,APBC_PXA168_ASFAR);
	__raw_writel(SECOND_SECURITY_VALUE,APBC_PXA168_ASSAR);
...
void mfp_gpio3_power_down(void)
{
	__raw_writel(FIRST_SECURITY_VALUE,APBC_PXA168_ASFAR);
	__raw_writel(SECOND_SECURITY_VALUE,APBC_PXA168_ASSAR);
