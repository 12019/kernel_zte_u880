...
#define CKEN_USBH	2	/* < USB host (OHCI) clock enable */
#define CKEN_CAMERA	3	/* < Camera interface clock enable */
#define CKEN_NAND	4	/* < NAND Flash Controller Clock Enable */
#define CKEN_USB2	6	/* < USB 2.0 client (OHCI) clock enable. */
...
#define CKEN_USB_EHCI		70	/* USB2.0 OTG (EHCI) clock enable */
#define CKEN_USBH_EHCI		71	/* USB2.0 Host (EHCI) clock enable */
#define CKEN_USB_EHCI_BUS	74	/* USB2.0 OTG (EHCI) System Bus clock enable */
#define CKEN_USBH_EHCI_BUS	75	/* USB2.0 Host (EHCI) System Bus clock enable */
