...
#define GPIO94_SPI_DCLK		MFP_CFG_PULL(GPIO94, AF3, LOW)
#define GPIO95_SPI_CS0		MFP_CFG_PULL(GPIO95, AF3, HIGH)
#define GPIO96_SPI_DIN		MFP_CFG_PULL(GPIO96, AF3, LOW)

#define GPIO97_SPI_DOUT		MFP_CFG_DRV(GPIO97, AF3, FAST)
#define GPIO98_LCD_RST		MFP_CFG_DRV(GPIO98, AF0, FAST)

#define GPIO83_LCD_RST		MFP_CFG_DRV(GPIO83, AF0, FAST)
#define GPIO89_LCD_5V_BIAS	MFP_CFG_DRV(GPIO89, AF0, FAST)
#define GPIO114_MN_CLK_OUT	MFP_CFG_PULL(GPIO114, AF1, HIGH)
