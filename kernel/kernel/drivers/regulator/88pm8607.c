...
static int pm8607_list_voltage(struct regulator_dev *rdev, unsigned index)
{
	...
	case PM8607_ID_BUCK1:
		ret = (index < 0x1f) ? (index * 25000 + 725000) :
			((index < 0x3f) ? ((index - 0x20) * 25000) :
			-EINVAL);
		break;
...
static struct pm8607_regulator_info pm8607_regulator_info[] = {
	...
	PM8607_LDO(10, 1200, 3300, 0, LDO10, 0, 4, SUPPLIES_EN12, 4),
	PM8607_LDO(12, 1200, 3300, 0, LDO12, 0, 4, SUPPLIES_EN12, 5),
	PM8607_LDO(14, 1800, 3300, 0, LDO14, 0, 3, SUPPLIES_EN12, 6),
};
