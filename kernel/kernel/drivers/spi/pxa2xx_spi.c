...
static void init_dvfm_constraint(void)
{
	constraint_is_set = 0;
...
static void giveback(struct driver_data *drv_data)
{
	...
	unset_dvfm_constraint();	/*enable Low power mode after DMA */
}
...
static void pump_transfers(unsigned long data)
{
	...
	set_dvfm_constraint();	/* Disable the Low power mode in DMA */
...
static int __init pxa2xx_spi_probe(struct platform_device *pdev)
{
	...
	master = spi_alloc_master(dev, sizeof(struct driver_data) + DMA_ALIGNMENT);
	if (!master) {
