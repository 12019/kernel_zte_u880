...
/* Preview Configuraion*/
#define PREVIEW_CONFIG0			0   // SVGA normal
#define PREVIEW_CONFIG1			1   // SVGA night
#define PREVIEW_CONFIG2			2
#define PREVIEW_CONFIG3			3
#define PREVIEW_CONFIG4			4

/* Capture Configuraion*/
#define CAPTURE_CONFIG0			0   // SXGA (YUV)
#define CAPTURE_CONFIG1			1   // UXGA (YUV)
#define CAPTURE_CONFIG2			2   // QXGA (YUV)
#define CAPTURE_CONFIG3			3   // SXGA (JPEG)
#define CAPTURE_CONFIG4			4   // QXGA (JPEG)

#define S5K5CA_FRAME_RATE		30

#define PVI_MASK			0x0052// default 0x004A

/*
 * Information we maintain about a known sensor.
 */
struct s5k5ca_format_struct;  /* coming later */
struct s5k5ca_info {
	struct s5k5ca_format_struct *fmt;  /* Current format */
...
static struct regval_list s5k5ca_init_table1[] = {
	{0xFCFC, 0xD000},
	{0x0010, 0x0001},	//Reset
	...
	//SAMSUNG_Sensor_DelayMs(100},

static struct regval_list s5k5ca_init_table2[] = {
	{0x0028, 0x7000}, 
	{0x002A, 0x2CF8}, 
	{0x0F12, 0xB510}, 
	{0x0F12, 0x4827}, 
	...
	//002A 01E4 
	//0F12 0041  //REG_TC_IPRM_CM_Init_GpioConfig1 : 4 -  GPIO4 
	//002A 01E8 
	//0F12 2A0C  //REG_TC_IPRM_CM_Init_Mi2cBits : MSCL - GPIO1 MSDA - GPIO2 Device ID (0C)
	...
	//002A 1072 
	//0F12 003C  //#af_pos_usCaptureFixedPo// 0x0008
	//
	//// AF Lens Position Table Settings 
	//002A 1074 
	//0F12 0013  //#af_pos_usTableLastInd// 0~20 16 Steps 091222
	//0F12 002C  //#af_pos_usTable_0_// af_pos_usTable          
	//0F12 0030  //#af_pos_usTable_1_                           
	//0F12 0033  //#af_pos_usTable_2_                           
	//0F12 0036  //#af_pos_usTable_3_                           
	//0F12 0039  //#af_pos_usTable_4_                           
	//0F12 003D  //#af_pos_usTable_5_                           
	//0F12 0041  //#af_pos_usTable_6_                           
	//0F12 0045  //#af_pos_usTable_7_                           
	//0F12 0049  //#af_pos_usTable_8_                           
	//0F12 004F  //#af_pos_usTable_9_                           
	//0F12 0055  //#af_pos_usTable_10_                          
	//0F12 005D  //#af_pos_usTable_11_                          
	//0F12 0065  //#af_pos_usTable_12_                          
	//0F12 006D  //#af_pos_usTable_13_                          
	//0F12 0077  //#af_pos_usTable_14_                          
	//0F12 0083  //#af_pos_usTable_15_                          
	//0F12 008F  //#af_pos_usTable_16_  
	//0F12 009B  //#af_pos_usTable_17_                          
	//0F12 00A7  //#af_pos_usTable_18_  
	//0F12 00B3  //#af_pos_usTable_19_  
	//
	//002A 0252 
	//0F12 0003  //init 
	//
	//002A 12B8    //disable CINTR 0                                 
	//0F12 1000         
	//
	//============================================================
	// ISP-FE Setting
	...
	{0x002A, 0x0E44},     
	{0x0F12, 0x059A},//0x0525}, 	                                                                        
	{0x0F12, 0x0400}, 	                                                                        
	{0x0F12, 0x078C},//0x078C}, 	                                                                        
	...
	{0x002A, 0x01F6},                                                                        	
	{0x0F12, 0x30D4},	//0x1F40},    //REG_TC_IPRM_OpClk4KHz_0                   	2   700001F6         
	{0x0F12, 0x32A8},    //REG_TC_IPRM_MinOutRate4KHz_0              
	{0x0F12, 0x32E8},    //REG_TC_IPRM_MaxOutRate4KHz_0                        
	...
	{0x0F12, 0x30D4},	//0x0BB8},    //REG_TC_IPRM_OpClk4KHz_2                   	2   70000202 
	{0x0F12, 0x16F0},	//0x05DC},    //REG_TC_IPRM_MinOutRate4KHz_2              	2   70000204 
	{0x0F12, 0x17F0},	//0x1770},    //REG_TC_IPRM_MaxOutRate4KHz_2              	2   70000206 
	...
	// # Foramt : YUV422
	// # Size: 320*240
	// # FPS :7.5-15fps(using normal_mode preview)
	//================================================================================================
	{0x002A, 0x026C},
	{0x0F12, 0x0140}, //0280   //REG_0TC_PCFG_usWidth                      
	{0x0F12, 0x00F0}, //01E0   //REG_0TC_PCFG_usHeight                     	2   7000026E    //                                         
	{0x0F12, 0x0005},   //REG_0TC_PCFG_Format                       	2   70000270    //                                         
	{0x0F12, 0x32E8}, //32E8   //REG_0TC_PCFG_usMaxOut4KHzRate             
	{0x0F12, 0x32A8}, //32a8   //REG_0TC_PCFG_usMinOut4KHzRate             
	{0x0F12, 0x0100},   //REG_0TC_PCFG_OutClkPerPix88               	2   70000276    //                                         
	{0x0F12, 0x0800},   //REG_0TC_PCFG_uMaxBpp88                    	2   70000278    //                                         
	{0x0F12, 0x0052},   //REG_0TC_PCFG_PVIMask                      	2   7000027A    //92  (1) PCLK inversion  (4)1b_C first (5) UV First                                       
	...
	// # Foramt : YUV422
	// # Size: 144*176
	// # FPS :10-12fps(using normal_mode preview)
	//================================================================================================
	{0x002A, 0x029C},
	{0x0F12, 0x0090},   //REG_0TC_PCFG_usWidth                      
	{0x0F12, 0x00B0},   //REG_0TC_PCFG_usHeight                     	2   7000026E    //                                         
	{0x0F12, 0x0005},   //REG_0TC_PCFG_Format                       	2   70000270    //                                         
	{0x0F12, 0x32E8},   //REG_0TC_PCFG_usMaxOut4KHzRate             
	{0x0F12, 0x32a8},   //REG_0TC_PCFG_usMinOut4KHzRate             
	{0x0F12, 0x0100},   //REG_0TC_PCFG_OutClkPerPix88               	2   70000276    //                                         
	{0x0F12, 0x0800},   //REG_0TC_PCFG_uMaxBpp88                    	2   70000278    //                                         
	{0x0F12, 0x0052},   //REG_0TC_PCFG_PVIMask                      	2   7000027A    //92  (1) PCLK inversion  (4)1b_C first (5) UV First                                       
	{0x0F12, 0x0010},   //REG_0TC_PCFG_OIFMask                      	2   7000027C    //                                         
	...
	{0x0F12, 0x0000},   //REG_0TC_PCFG_usFrTimeType                 	2   70000284    //                                         
	{0x0F12, 0x0001},   //REG_0TC_PCFG_FrRateQualityType            	2   70000286    //                                         
	{0x0F12, 0x03E8},	//0x0535},   //REG_0TC_PCFG_usMaxFrTimeMsecMult10        	2   70000288    //                                         
	{0x0F12, 0x0341},	//0x029A},   //REG_0TC_PCFG_usMinFrTimeMsecMult10        	2   7000028A    //                                         
	{0x0F12, 0x0000},   //REG_0TC_PCFG_bSmearOutput                 	2   7000028C    //                                         
	{0x0F12, 0x0000},   //REG_0TC_PCFG_sSaturation                  	2   7000028E    //                                         
	{0x0F12, 0x0000},   //REG_0TC_PCFG_sSharpBlur                   	2   70000290    //                                         
	{0x0F12, 0x0000},   //REG_0TC_PCFG_sColorTemp                   	2   70000292    //                                         
	...
	{0x0F12, 0x0000},   //REG_0TC_PCFG_usFrTimeType                 	2   70000284    //                                         
	{0x0F12, 0x0001},   //REG_0TC_PCFG_FrRateQualityType            	2   70000286    //                                         
	{0x0F12, 0x01F4},	//0x0535},   //REG_0TC_PCFG_usMaxFrTimeMsecMult10        	2   70000288    //                                         
	{0x0F12, 0x01A1},	//0x029A},   //REG_0TC_PCFG_usMinFrTimeMsecMult10        	2   7000028A    //                                         
	{0x0F12, 0x0000},   //REG_0TC_PCFG_bSmearOutput                 	2   7000028C    //                                         
	{0x0F12, 0x0000},   //REG_0TC_PCFG_sSaturation                  	2   7000028E    //                                         
	{0x0F12, 0x0000},   //REG_0TC_PCFG_sSharpBlur                   	2   70000290    //                                         
	{0x0F12, 0x0000},   //REG_0TC_PCFG_sColorTemp                   	2   70000292    //                                         
	...
	{0x0F12, 0x0120},   //REG_0TC_PCFG_usHeight                     	2   7000026E    //                                         
	{0x0F12, 0x0005},   //REG_0TC_PCFG_Format                       	2   70000270    //                                         
	{0x0F12, 0x32E8},   //REG_0TC_PCFG_usMaxOut4KHzRate             
	{0x0F12, 0x32a8},   //REG_0TC_PCFG_usMinOut4KHzRate             
	{0x0F12, 0x0100},   //REG_0TC_PCFG_OutClkPerPix88               	2   70000276    //                                         
	...
	{0x0F12, 0x0000},   //REG_0TC_PCFG_usFrTimeType                 	2   70000284    //                                         
	{0x0F12, 0x0001},   //REG_0TC_PCFG_FrRateQualityType            	2   70000286    //                                         
	{0x0F12, 0x01F4},//24fps	//0x0535},   //REG_0TC_PCFG_usMaxFrTimeMsecMult10        	2   70000288    //                                         
	{0x0F12, 0x01A1},//24fps	//0x029A},   //REG_0TC_PCFG_usMinFrTimeMsecMult10        	2   7000028A    //                                         
	{0x0F12, 0x0000},   //REG_0TC_PCFG_bSmearOutput                 	2   7000028C    //                                         
	{0x0F12, 0x0000},   //REG_0TC_PCFG_sSaturation                  	2   7000028E    //                                         
	{0x0F12, 0x0000},   //REG_0TC_PCFG_sSharpBlur                   	2   70000290    //                                         
	{0x0F12, 0x0000},   //REG_0TC_PCFG_sColorTemp                   	2   70000292    //                                         
	...
	{0x0F12, 0x0009},   //REG_0TC_CCFG_Format                       	2   70000362          //                                   
	{0x0F12, 0x32E8},   //REG_0TC_CCFG_usMaxOut4KHzRate             
	{0x0F12, 0x32a8},   //REG_0TC_CCFG_usMinOut4KHzRate             
	{0x0F12, 0x0100},   //REG_0TC_CCFG_OutClkPerPix88               	2   70000368          //                                   
	{0x0F12, 0x0800},   //REG_0TC_CCFG_uMaxBpp88                    	2   7000036A          //                                   
	{0x0F12, 0x0052},   //REG_0TC_CCFG_PVIMask                      	2   7000036C          //                                   
	...
	// # FPS :7.5fps                                                
	//================================================================================================  
	{0x002A, 0x03B4},   //Normal capture //    	
	{0x0F12, 0x0000},   //REG_0TC_CCFG_uCaptureMode                 	2   7000035C
	{0x0F12, 0x0400},   //REG_0TC_CCFG_usWidth                      	2   7000035E          //                                   
	{0x0F12, 0x0300},   //REG_0TC_CCFG_usHeight                     	2   70000360          //                                   
	{0x0F12, 0x0009},   //REG_0TC_CCFG_Format                       	2   70000362          //                                   
	{0x0F12, 0x32E8},   //REG_0TC_CCFG_usMaxOut4KHzRate             
	{0x0F12, 0x32a8},   //REG_0TC_CCFG_usMinOut4KHzRate             
	{0x0F12, 0x0100},   //REG_0TC_CCFG_OutClkPerPix88               	2   70000368          //                                   
...
static struct regval_list s5k5ca_init_table3[] = {
    {0x002A, 0x0DA0},
    {0x0F12, 0x0005},
...
// only electronic rolling shutter needs anti-fliker
typedef enum 
{
...
/* White Balance */
static struct regval_list s5k5ca_whitebalance_auto[] = {
	{0x0028, 0x7000},
	{0x002A, 0x246E}, 
	{0x0F12, 0x0001},
	{0xFFFF, 0xFFFF},
...
static struct regval_list s5k5ca_whitebalance_cloud[] = {
//<CAMTUNING_WHITE_BALANCE_
	{0xfcfc, 0xd000},        
	{0x0028, 0x7000},        
	{0x002a, 0x246E}, 	     
	{0x0f12, 0x0000},        
...
static struct regval_list s5k5ca_whitebalance_daylight[] = {
	{0xfcfc, 0xd000},
	{0x0028, 0x7000},
	{0x002a, 0x246E},
	{0x0f12, 0x0000},
...
static struct regval_list s5k5ca_whitebalance_incandescence[] = {
	{0xfcfc, 0xd000},          
	{0x0028, 0x7000},          
	{0x002a, 0x246E}, 	       
	{0x0f12, 0x0000},          
...
static struct regval_list s5k5ca_whitebalance_fluorescent[] = {
	{0xfcfc, 0xd000},  
	{0x0028, 0x7000},  
	{0x002a, 0x246E}, 	
	{0x0f12, 0x0000},  
...
static struct regval_list s5k5ca_whitebalance_tungsten[] = {
	{0x0028, 0x7000},	
	{0x002A, 0x246E},		
	{0x0F12, 0x0677}, 
	...
	{0x002A, 0x04A4},		//G Gain
	{0x0F12, 0x0100}, 
	{0x0F12, 0x0001},

	{0x002A, 0x04A8},		//B Gain
	{0x0F12, 0x021E}, 
	{0x0F12, 0x0001},
	{0xFFFF, 0xFFFF},
};
...
/* Evoffset */
static struct regval_list s5k5ca_evoffset_neg4_3[] = {
	{0x0028, 0x7000},
	{0x002A, 0x020C},         //REG_TC_UserBrightness
	{0x0F12, 0xFFCF},	//0xFFFF-(4*12)}
	{0xFFFF, 0xFFFF},
};

static struct regval_list s5k5ca_evoffset_neg3_3[] = {
	{0x0028, 0x7000},
	{0x002A, 0x020C},         //REG_TC_UserBrightness
	{0x0F12, 0xFFDB},	//0xFFFF-(3*12)}
	{0xFFFF, 0xFFFF},
};

static struct regval_list s5k5ca_evoffset_neg2_3[] = {
	{0x0028, 0x7000},
	{0x002A, 0x020C},         //REG_TC_UserBrightness
	{0x0F12, 0xFFE7},	//0xFFFF-(2*12)}
	{0xFFFF, 0xFFFF},
};

static struct regval_list s5k5ca_evoffset_neg1_3[] = {
	{0x0028, 0x7000},
	{0x002A, 0x020C},         //REG_TC_UserBrightness
	{0x0F12, 0xFFF3},	//0xFFFF-(1*12)}
 	{0xFFFF, 0xFFFF},
};

static struct regval_list s5k5ca_evoffset_zero[] = {
	{0x0028, 0x7000},
	{0x002A, 0x020C},         //REG_TC_UserBrightness
	{0x0F12, 0x0000},  	//003D
 	{0xFFFF, 0xFFFF},
...
static struct regval_list s5k5ca_evoffset_pos1_3[] = {
	{0x0028, 0x7000},
	{0x002A, 0x020C},         //REG_TC_UserBrightness
	{0x0F12, 0x000E},	//x0000+(1*14)}
	{0xFFFF, 0xFFFF},
};

static struct regval_list s5k5ca_evoffset_pos2_3[] = {
	{0x0028, 0x7000},
	{0x002A, 0x020C},         //REG_TC_UserBrightness
	{0x0F12, 0x001C},	//0x0000+(2*14)}
	{0xFFFF, 0xFFFF},
};

static struct regval_list s5k5ca_evoffset_pos3_3[] = {
	{0x0028, 0x7000},
	{0x002A, 0x020C},         //REG_TC_UserBrightness
	{0x0F12, 0x0002A},	//x0000+(3*14)}
	{0xFFFF, 0xFFFF},
};

static struct regval_list s5k5ca_evoffset_pos4_3[] = {
	{0x0028, 0x7000},
	{0x002A, 0x020C},         //REG_TC_UserBrightness
	{0x0F12, 0x0038},	//0x0000+(4*14)}
	{0xFFFF, 0xFFFF},
};


/* ColoreEffect */
static struct regval_list s5k5ca_coloreffect_normal[] = {
	{0x0028, 0x7000},	
	{0x002A, 0x021E},	
	{0x0F12, 0x0000},  				   
	{0xFFFF, 0xFFFF},
...
static struct regval_list s5k5ca_coloreffect_grayscale[] = {
	{0x0028, 0x7000},	
	{0x002A, 0x021E},
	{0x0F12, 0x0001},  
	{0xFFFF, 0xFFFF},
...
static struct regval_list s5k5ca_coloreffect_sepia[] = {
	{0x0028, 0x7000},	
	{0x002A, 0x021E},
	{0x0F12, 0x0004},    
	{0xFFFF, 0xFFFF},
...
static struct regval_list s5k5ca_coloreffect_colorinv[] = {
	{0x0028, 0x7000},	
	{0x002A, 0x021E},
	{0x0F12, 0x0002},  
	{0xFFFF, 0xFFFF},
...
static struct regval_list s5k5ca_coloreffect_sepiablue[] = {
	{0x0028, 0x7000},					
	{0x002A, 0x021E},
	{0x0F12, 0x0004},  				   
	{0xFFFF, 0xFFFF},
...
static struct regval_list s5k5ca_coloreffect_sketch[] = {
	{0x0028, 0x7000},					
	{0x002A, 0x021E},
	{0x0F12, 0x0005},  				   
	{0xFFFF, 0xFFFF},
...
/* Contrast */
static struct regval_list s5k5ca_contrast_neg_2[] = {
	{0x0028, 0x7000},
	{0x002A, 0x020E},	//#TVAR_ae_BrAve //ae target
	{0x0F12, 0xFFCE},  
	{0xFFFF, 0xFFFF},
};

static struct regval_list s5k5ca_contrast_neg_1[] = {
	{0x0028, 0x7000},
	{0x002A, 0x020E},	//#TVAR_ae_BrAve //ae target
	{0x0F12, 0xFFE7}, 
	{0xFFFF, 0xFFFF},
...
static struct regval_list s5k5ca_contrast_zero[] = {
	{0x0028, 0x7000},
	{0x002A, 0x020E},	//#TVAR_ae_BrAve //ae target
	{0x0F12, 0x0000},  
	{0xFFFF, 0xFFFF},
...
static struct regval_list s5k5ca_contrast_pos_1[] = {
	{0x0028, 0x7000},
	{0x002A, 0x020E},	//#TVAR_ae_BrAve //ae target
	{0x0F12, 0x0040},  
	{0xFFFF, 0xFFFF},
...
static struct regval_list s5k5ca_contrast_pos_2[] = {
	{0x0028, 0x7000},
	{0x002A, 0x020E},	//#TVAR_ae_BrAve //ae target
	{0x0F12, 0x0081},  
	{0xFFFF, 0xFFFF},
...
/* Sharpness */
static struct regval_list s5k5ca_sharpness_neg_2[] = {
	{0x0028, 0x7000},
	{0x002A, 0x0212},	//#TVAR_ae_BrAve //ae target
	{0x0F12, 0xFF81}, 
	{0xFFFF, 0xFFFF},
};

static struct regval_list s5k5ca_sharpness_neg_1[] = {
	{0x0028, 0x7000},
	{0x002A, 0x0212},	//#TVAR_ae_BrAve //ae target
	{0x0F12, 0xFFFF}, 
	{0xFFFF, 0xFFFF},
...
static struct regval_list s5k5ca_sharpness_zero[] = {
	{0x0028, 0x7000},
	{0x002A, 0x0212},	//#TVAR_ae_BrAve //ae target
	{0x0F12, 0x0000}, 
	{0xFFFF, 0xFFFF},
...
static struct regval_list s5k5ca_sharpness_pos_1[] = {
	{0x0028, 0x7000},
	{0x002A, 0x0212},	//#TVAR_ae_BrAve //ae target
	{0x0F12, 0x0030}, 
	{0xFFFF, 0xFFFF},
...
static struct regval_list s5k5ca_sharpness_pos_2[] = {
	{0x0028, 0x7000},
	{0x002A, 0x0212},	//#TVAR_ae_BrAve //ae target
	{0x0F12, 0x0060},  
	{0xFFFF, 0xFFFF},
...
/* Satuation */
static struct regval_list s5k5ca_satuation_neg_2[] = {
	{0x0028, 0x7000},
	{0x002A, 0x0210},	//#TVAR_ae_BrAve //ae target
	{0x0F12, 0xFFCE},  
	{0xFFFF, 0xFFFF},
};

static struct regval_list s5k5ca_satuation_neg_1[] = {
	{0x0028, 0x7000},
	{0x002A, 0x0210},	//#TVAR_ae_BrAve //ae target
	{0x0F12, 0xFFE7},  
	{0xFFFF, 0xFFFF},
...
static struct regval_list s5k5ca_satuation_zero[] = {
	{0x0028, 0x7000},
	{0x002A, 0x0210},	//#TVAR_ae_BrAve //ae target
	{0x0F12, 0x0000},  
	{0xFFFF, 0xFFFF},
...
static struct regval_list s5k5ca_satuation_pos_1[] = {
	{0x0028, 0x7000},
	{0x002A, 0x0210},	//#TVAR_ae_BrAve //ae target
	{0x0F12, 0x0019},  
	{0xFFFF, 0xFFFF},
...
static struct regval_list s5k5ca_satuation_pos_2[] = {
	{0x0028, 0x7000},
	{0x002A, 0x0210},	//#TVAR_ae_BrAve //ae target
	{0x0F12, 0x0032}, 
	{0xFFFF, 0xFFFF},
...
/* Brightness */
static struct regval_list s5k5ca_brightness_neg_3[] = {
	{0x0028, 0x7000},
	{0x002A, 0x020C},	//#TVAR_ae_BrAve //ae target
	{0x0F12, 0xFF81}, 
	{0xFFFF, 0xFFFF},
};

static struct regval_list s5k5ca_brightness_neg_2[] = {
	{0x0028, 0x7000},
	{0x002A, 0x020C},	//#TVAR_ae_BrAve //ae target
	{0x0F12, 0xFFDE}, 
	{0xFFFF, 0xFFFF},
...
static struct regval_list s5k5ca_brightness_neg_1[] = {
	{0x0028, 0x7000},
	{0x002A, 0x020C},	//#TVAR_ae_BrAve //ae target
	{0x0F12, 0xFFEE}, 
	{0xFFFF, 0xFFFF},
...
static struct regval_list s5k5ca_brightness_zero[] = {
	{0x0028, 0x7000},
	{0x002A, 0x020C},	//#TVAR_ae_BrAve //ae target
	{0x0F12, 0x0000}, 
	{0xFFFF, 0xFFFF},
...
static struct regval_list s5k5ca_brightness_pos_1[] = {
	{0x0028, 0x7000},
	{0x002A, 0x020C},	//#TVAR_ae_BrAve //ae target
	{0x0F12, 0x0012}, 
	{0xFFFF, 0xFFFF},
...
static struct regval_list s5k5ca_brightness_pos_2[] = {
	{0x0028, 0x7000},
	{0x002A, 0x020C},	//#TVAR_ae_BrAve //ae target
	{0x0F12, 0x003e}, 
	{0xFFFF, 0xFFFF},
...
static struct regval_list s5k5ca_brightness_pos_3[] = {
	{0x0028, 0x7000},
	{0x002A, 0x020C},	//#TVAR_ae_BrAve //ae target
	{0x0F12, 0x007f}, 
	{0xFFFF, 0xFFFF},
...
/* ISO */
static struct regval_list s5k5ca_iso_auto[] = {
//<CAMTUNING_ISO_AUTO>
{0xfcfc,0xd000},
{0x0028,0x7000},
{0x002A,0x12B8},  
...
static struct regval_list s5k5ca_iso_100[] = {
//<CAMTUNING_ISO_100>
{0xfcfc,0xd000},
{0x0028,0x7000},
{0x002A,0x12B8},  
...
static struct regval_list s5k5ca_iso_200[] = {
//<CAMTUNING_ISO_200>
{0xfcfc,0xd000},
{0x0028,0x7000},
{0x002A,0x12B8},  
...
static struct regval_list s5k5ca_iso_400[] = {
//<CAMTUNING_ISO_400>
{0xfcfc,0xd000},
{0x0028,0x7000},
{0x002A,0x12B8},  
...
static struct regval_list s5k5ca_iso_800[] = {
//<CAMTUNING_ISO_800>
{0xfcfc,0xd000},
{0x0028,0x7000},
{0x002A,0x12B8},  
...
static struct regval_list s5k5ca_zoom_100[] = {
    {0x0028, 0x7000},
    {0x002A, 0x0474},
    {0x0F12, 0x0100},
    {0x002A, 0x0466},
...
static struct regval_list s5k5ca_zoom_120[] = {
    {0x0028, 0x7000},
    {0x002A, 0x0474},
    {0x0F12, 0x0120},
    {0x002A, 0x0466},
...
static struct regval_list s5k5ca_zoom_140[] = {
    {0x0028, 0x7000},
    {0x002A, 0x0474},
    {0x0F12, 0x0140},
    {0x002A, 0x0466},
...
static struct regval_list s5k5ca_zoom_160[] = {
    {0x0028, 0x7000},
    {0x002A, 0x0474},
    {0x0F12, 0x0160},
    {0x002A, 0x0466},
...
static struct regval_list s5k5ca_zoom_180[] = {
    {0x0028, 0x7000},
    {0x002A, 0x0474},
    {0x0F12, 0x0180},
    {0x002A, 0x0466},
...
static struct regval_list s5k5ca_zoom_200[] = {
    {0x0028, 0x7000},
    {0x002A, 0x0474},
    {0x0F12, 0x0200},
    {0x002A, 0x0466},
...
static struct regval_list s5k5ca_zoom_220[] = {
    {0x0028, 0x7000},
    {0x002A, 0x0474},
    {0x0F12, 0x0220},
    {0x002A, 0x0466},
...
static struct regval_list s5k5ca_zoom_240[] = {
    {0x0028, 0x7000},
    {0x002A, 0x0474},
    {0x0F12, 0x0240},
    {0x002A, 0x0466},
...
static struct regval_list s5k5ca_zoom_260[] = {
    {0x0028, 0x7000},
    {0x002A, 0x0474},
    {0x0F12, 0x0260},
    {0x002A, 0x0466},
...
static struct regval_list s5k5ca_zoom_280[] = {
    {0x0028, 0x7000},
    {0x002A, 0x0474},
    {0x0F12, 0x0280},
    {0x002A, 0x0466},
...
static struct regval_list s5k5ca_zoom_300[] = {
    {0x0028, 0x7000},
    {0x002A, 0x0474},
    {0x0F12, 0x0300},
    {0x002A, 0x0466},
...
/* Banding */
static struct regval_list s5k5ca_banding_50hz[] = { 
	{0x0028, 0x7000},
	{0x002A, 0x04D2},
	{0x0F12, 0x065F}, 
...
static struct regval_list s5k5ca_banding_60hz[] = { 
	{0x0028, 0x7000},
	{0x002A, 0x04D2},
	{0x0F12, 0x065F}, 
...
/* Mirror */
static struct regval_list s5k5ca_mirror_normal[] = {
	{0x002A, 0x0296}, 
	{0x0F12, 0x0000},
	{0x0F12, 0x0000},
	{0x002A, 0x02C6}, 
...
static struct regval_list s5k5ca_h_mirror[] = {
	{0x002A, 0x0296}, 
	{0x0F12, 0x0001},
	{0x0F12, 0x0001},
	{0x002A, 0x02C6}, 
...
static struct regval_list s5k5ca_v_mirror[] = {
	{0x002A, 0x0296}, 
	{0x0F12, 0x0002},
	{0x0F12, 0x0002},
	{0x002A, 0x02C6}, 
...
#if 0
static struct regval_list s5k5ca_hv_mirror[] = {
	{0x002A, 0x0296}, 
	{0x0F12, 0x0003},
	{0x0F12, 0x0003},
	{0x002A, 0x02C6}, 
