			...
			unsigned int cmd, unsigned long arg)
{
	...
	num = copy_from_user(&acipc_arg, (void *)arg,
	...
	num = copy_to_user((void *)arg, &acipc_arg, sizeof(struct acipc_ioctl_arg));
...
failed_freemem:
	release_mem_region(acipc->mem->start, resource_size(acipc->mem));
failed_deregmisc:
