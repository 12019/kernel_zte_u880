...
static void pm860x_system_poweroff(void)
{
	u8 tmp;
...
static irqreturn_t pm860x_onkey_handler(int irq, void *data)
{
	...
	printk("pm860x_onkey is pressed... key= %d\n", KEY_POWER);    //added by chelei20101231 for debug
	/* Enable 8-second long onkey detection */
	pm860x_set_bits(info->i2c, PM8607_WAKEUP, 3, 0);
	return IRQ_HANDLED;
}
