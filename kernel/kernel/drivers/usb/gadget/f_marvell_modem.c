...
static struct usb_interface_assoc_descriptor acm_iad_desc __initdata = {
...
static int __init acm_bind(struct usb_configuration *c, struct usb_function *f)
{
	...
	#else
	acm_iad_desc.bInterfaceCount = 0x1;
	#endif
 ...
 */
static int __init acm_bind_config(struct usb_configuration *c, u8 port_num)
{
	struct f_acm *acm;
	int status;
...
#endif /* CONFIG_USB_ANDROID_MARVELL_MODEM */
