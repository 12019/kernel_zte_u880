...
rndis_bind(struct usb_configuration *c, struct usb_function *f)
{
	...
	/* init iad */
	rndis_iad_desc.bFirstInterface = rndis->ctrl_id;
	rndis_iad_desc.bInterfaceCount = 0x2;
	rndis_iad_desc.bFunctionClass = rndis_control_intf.bInterfaceClass;
	rndis_iad_desc.bFunctionSubClass = \
		rndis_control_intf.bInterfaceSubClass;
	rndis_iad_desc.bFunctionProtocol = \
