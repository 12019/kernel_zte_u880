...
#define PM8607_C0_VERSION		(0x50)	/* 8607 chip ID */
#define PM8607_C1D_VERSION		(0x51)	/* 8607 chip ID */
#define PM8607_D0_VERSION		(0x58)	/* 8607 chip ID */
...
struct pm860x_platform_data {
	...
	struct pm860x_vibrator_pdata	*vibrator;
