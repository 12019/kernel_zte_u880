...
/* pm860x audio register space */
#define PM860X_AUDIO_OFFSET    0xB0
...
#define PCM_INTERFACE4        0x39
#define I2S_INTERFACE_5       0x3a
#define SHORTS		      0x3b

#define PM860X_AUDIO_END    0x3b
/* pm860x audio clk related register */
#define PM860X_AUDIO_MISC_OFFSET 0x42
#define MISC2		      (PM860X_AUDIO_END + 0x1)
#define PLL_CTRL1	      (PM860X_AUDIO_END + 0x2)
#define PLL_FRAC1	      (PM860X_AUDIO_END + 0x3)
#define PLL_FRAC2	      (PM860X_AUDIO_END + 0x4)
#define PLL_FRAC3	      (PM860X_AUDIO_END + 0x5)
#define SAMPLE_RATE_SWITCH		(PM860X_AUDIO_END + 0x6)

#define MICCO_FM2018_EN	0x47
#define MICCO_TPA2018_EN	0x48
#define MICCO_FM2018_MODE  	0x49
#define  Bt_Codec_switch	0x45
